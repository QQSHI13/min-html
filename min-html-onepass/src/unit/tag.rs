...
use min_html_common::gen::attrs::AttributeMinification;
use min_html_common::gen::attrs::ATTRS;
...
use min_html_common::spec::tag::omission::can_omit_as_before;
use min_html_common::spec::tag::omission::can_omit_as_last_node;
