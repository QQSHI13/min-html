...
///
/// ```
/// use min_html_onepass::{Cfg, Error, in_place};
///
...
///
/// ```
/// use min_html_onepass::{Cfg, Error, in_place_str};
///
...
///
/// ```
/// use min_html_onepass::{Cfg, Error, truncate};
///
/// let mut code = b"<p>  Hello, world!  </p>".to_vec();
/// let cfg = &Cfg {
///     minify_js: false,
...
///
/// ```
/// use min_html_onepass::{Cfg, Error, copy};
///
...
///
/// ```
/// use min_html_onepass::{Cfg, FriendlyError, with_friendly_error};
///
