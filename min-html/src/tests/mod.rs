...
use min_html_common::tests::create_common_css_test_data;
use min_html_common::tests::create_common_js_test_data;
use min_html_common::tests::create_common_noncompliant_test_data;
use min_html_common::tests::create_common_test_data;
...
fn test_svg_foreign_content_case_preserved() {
  ...
  // min-html must not lowercase viewBox / preserveAspectRatio / camelCase
