...
use memchr::memchr;
use min_html_common::gen::codepoints::Lookup;
use min_html_common::gen::codepoints::ALPHANUMERIC_OR_EQUALS;
use min_html_common::gen::codepoints::DIGIT;
use min_html_common::gen::codepoints::HEX_DIGIT;
use min_html_common::gen::codepoints::LOWER_HEX_ALPHA;
use min_html_common::gen::codepoints::UPPER_HEX_ALPHA;
use min_html_common::gen::entities::EntityType;
use min_html_common::gen::entities::ENTITY;
use min_html_common::pattern::TrieNodeMatch;
