...
use ahash::AHashMap;
use min_html_common::gen::codepoints::ATTR_QUOTE;
use min_html_common::gen::codepoints::DOUBLE_QUOTE;
use min_html_common::gen::codepoints::NOT_UNQUOTED_ATTR_VAL_CHAR;
use min_html_common::gen::codepoints::SINGLE_QUOTE;
use min_html_common::gen::codepoints::TAG_NAME_CHAR;
use min_html_common::gen::codepoints::WHITESPACE;
use min_html_common::gen::codepoints::WHITESPACE_OR_SLASH;
use min_html_common::gen::codepoints::WHITESPACE_OR_SLASH_OR_EQUALS_OR_RIGHT_CHEVRON;
use min_html_common::spec::script::JAVASCRIPT_MIME_TYPES;
use min_html_common::spec::tag::ns::Namespace;
use min_html_common::spec::tag::void::VOID_TAGS;
use min_html_common::spec::tag::whitespace::HTML_TAG_WHITESPACE_MINIFICATION;
use std::fmt::Debug;
