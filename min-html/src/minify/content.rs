...
use min_html_common::pattern::Replacer;
use min_html_common::spec::tag::ns::Namespace;
use min_html_common::spec::tag::whitespace::get_whitespace_minification_for_tag;
use min_html_common::spec::tag::whitespace::WhitespaceMinification;
use min_html_common::whitespace::collapse_whitespace;
use min_html_common::whitespace::is_all_whitespace;
use min_html_common::whitespace::left_trim;
use min_html_common::whitespace::right_trim;
